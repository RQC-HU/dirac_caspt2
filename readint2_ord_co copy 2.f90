           ...
           elseif (max1 == 3 .and. min1 == 1 .and. max2 == 2 .and. min2 == 1) then ! (31|21)=>(31|12)
               ...
               if (i > j .and. l > k) then ! (31|12)=>(31|21) For E
                   ...
                   if (ioerr .ne. 0) then
                       ...
                       caspt2_mdcint_cnt = caspt2_mdcint_cnt + 1
                       e_cnt = e_cnt + 1
                   end if                   !    write (unit_c3) i, j, k, l, rklr(inz), rkli(inz)
               ...
               elseif (j > i .and. l > k) then ! (13|12)=>(31|21) For E
                   ...
                   if (ioerr .ne. 0) then
                       ...
                       caspt2_mdcint_cnt = caspt2_mdcint_cnt + 1
                       e_cnt = e_cnt + 1
                   end if                   !    write (unit_c3) jtr, itr, k, l, SignIJ*rklr(inz), SignIJ*rkli(inz)
               ...
               elseif (i > j .and. k > l) then ! (31|21)=>(31|21) For E
                   ...
                   if (ioerr .ne. 0) then
                       ...
                       caspt2_mdcint_cnt = caspt2_mdcint_cnt + 1
                       e_cnt = e_cnt + 1
                   end if                   !    write (unit_c3) i, j, ltr, ktr, SignKL*rklr(inz), SignKL*rkli(inz)
               ...
               elseif (i < j .and. k > l) then ! (13|21)=>(31|21) For E
                   ...
                   if (ioerr .ne. 0) then
                       ...
                       caspt2_mdcint_cnt = caspt2_mdcint_cnt + 1
                       e_cnt = e_cnt + 1
                   end if                   !    write (unit_c3) jtr, itr, ltr, ktr, SignIJ*SignKL*rklr(inz), SignIJ*SignKL*rkli(inz)
