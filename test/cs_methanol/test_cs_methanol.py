...
def test_methanol_slow(the_number_of_process: int) -> None:
    ...
    # Set file names
    ref_filename = "reference.methanol.out"  # Reference
    output_filename = "methanol.caspt2.out"  # Output (This file is compared with Reference)
    latest_passed_output = "latest_passed.methanol.caspt2.out"  # latest passed output (After test, the output file is moved to this)
