...
! Subroutine read_mdcint_kr ! 2 Electorn Integrals In Mdcint
program read_mdcint_kr
...
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    open (11, file="kr_infomation", form="formatted", status="unknown")
...
!         call MPI_Bcast(kr(-nmo/2), nmo+1, MPI_INT, 0, MPI_COMM_WORLD, ierr)
...
1000 close (rank + 100)
    ...
    ! close(10)
    close (8)
! end Subroutine read_mdcint_kr
end program read_mdcint_kr
