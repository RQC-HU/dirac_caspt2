            ...
            do k = ninact + 1, ninact + nact              ! ACTIVE SPACE
                do l = ninact + 1, ninact + nact           ! ACTIVE SPACE
                    If (realcvec) then
                        ...
                        fock_cmplx(i, j) = fock_cmplx(i, j) + dr*DCMPLX(inttwr(i, j, k, l), inttwi(i, j, k, l))
                        fock_cmplx(i, j) = fock_cmplx(i, j) - dr*DCMPLX(inttwr(i, l, k, j), inttwi(i, l, k, j))
                    Else
                        dr = 0.0d+00
        ...
        do j = i, ninact + nact + nsec
            ...
            do k = ninact + 1, ninact + nact              ! ACTIVE SPACE
                do l = ninact + 1, ninact + nact           ! ACTIVE SPACE
                    If (realcvec) then
                        Call dim1_density_R(k - ninact, l - ninact, dr)
                        fock_cmplx(i, j) = fock_cmplx(i, j) + dr*DCMPLX(int2r_f1(i, j, k, l), int2i_f1(i, j, k, l))
                        fock_cmplx(i, j) = fock_cmplx(i, j) - dr*DCMPLX(int2r_f2(i, l, k, j), int2i_f2(i, l, k, j))
                    Else
                        Call dim1_density(k - ninact, l - ninact, dr, di)
                        dens = DCMPLX(dr, di)
