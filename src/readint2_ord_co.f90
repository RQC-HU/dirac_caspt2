...
10  if (rank == 0) write (*, *) 'error for opening mdcint 10'
    go to 100
20  if (rank == 0) write (*, *) 'error for reading mdcint 20'
    go to 100
30  if (rank == 0) write (*, *) 'end mdcint 30'
    go to 100
40  if (rank == 0) write (*, *) 'error for reading mdcint 40'
    go to 100
50  if (rank == 0) write (*, *) 'end mdcint 50 normal'
    go to 100
